...
package com.google.api.services.playerendpoint;
...
public class Playerendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://kattam-tictactoe.appspot.com/_ah/api/";
  ...
  public class Get extends PlayerendpointRequest<com.google.api.services.playerendpoint.model.Player> {
    ...
    protected Get(java.lang.String email) {
      super(Playerendpoint.this, "GET", REST_PATH, null, com.google.api.services.playerendpoint.model.Player.class);
   ...
   *
   * @param content the {@link com.google.api.services.playerendpoint.model.Player}
   * @return the request
   */
  public Insert insert(com.google.api.services.playerendpoint.model.Player content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends PlayerendpointRequest<com.google.api.services.playerendpoint.model.Player> {
     ...
     * @since 1.13
     */
    protected Insert(com.google.api.services.playerendpoint.model.Player content) {
      super(Playerendpoint.this, "POST", REST_PATH, content, com.google.api.services.playerendpoint.model.Player.class);
    }
  ...
  public class List extends PlayerendpointRequest<com.google.api.services.playerendpoint.model.CollectionResponsePlayer> {
     ...
     */
    protected List() {
      super(Playerendpoint.this, "GET", REST_PATH, null, com.google.api.services.playerendpoint.model.CollectionResponsePlayer.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.String email, com.google.api.services.playerendpoint.model.Player content) throws java.io.IOException {
    Patch result = new Patch(email, content);
    initialize(result);
    return result;
  }

  public class Patch extends PlayerendpointRequest<com.google.api.services.playerendpoint.model.Player> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.String email, com.google.api.services.playerendpoint.model.Player content) {
      super(Playerendpoint.this, "PATCH", REST_PATH, content, com.google.api.services.playerendpoint.model.Player.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
  ...
  public class Remove extends PlayerendpointRequest<com.google.api.services.playerendpoint.model.Player> {
    ...
    protected Remove(java.lang.String id) {
      super(Playerendpoint.this, "DELETE", REST_PATH, null, com.google.api.services.playerendpoint.model.Player.class);
   ...
   * @return the request
   */
  public Update update(com.google.api.services.playerendpoint.model.Player content) throws java.io.IOException {
    Update result = new Update(content);
    initialize(result);
    return result;
  }

  public class Update extends PlayerendpointRequest<com.google.api.services.playerendpoint.model.Player> {
     ...
     * @since 1.13
     */
    protected Update(com.google.api.services.playerendpoint.model.Player content) {
      super(Playerendpoint.this, "PUT", REST_PATH, content, com.google.api.services.playerendpoint.model.Player.class);
    }
